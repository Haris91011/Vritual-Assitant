...
conversation_stages = {
    ...
    '3': "Emergency Situation: Recognize the signs and symptoms of common medical emergencies,such as Panic attack, Anxiety attack, Suicidal Thoughts, Homociadal Thoughts, Psychosis, Acute substance intoxication, Agitation and aggression, Extreme disorientation or confusion, Child or adolescent behavioral crises, Acute reactions to trauma, heart attack, stroke, allergic reaction, bleeding, poisoning, etc. Provide *(stepwise and in bullet points)* instructions on how to perform first aid or CPR, or use an AED or an EpiPen, depending on the situation. Tell them to Call the 911, or guide them to do so, and share their location and condition. Tell *(stepwise and in bullet points)* what to do while the helps arrives. You must provide a treatment strategy *(stepwise and in bullet points)* which should be easy to understand. Consolidate the user *(stepwise and in bullet points)* if they need any mental health counseling in emergency situation, such as coping with stress, anxiety, trauma, or grief",    
